...
#                 --master_addr=<IP_of_rank_0> --master_port=29500 train_llama.py <llama_access_token> <arg1> <arg2> ...
#
...
required_torch_version = "2.3.1"
current_version = torch.__version__

if version.parse(current_version) >= version.parse(required_torch_version):
